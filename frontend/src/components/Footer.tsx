        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Logo size={32} />
              <span className="text-lg font-semibold text-text-primary">Antystyki</span>
            </div>
          ...
          {/* Column 2: Navigation */}
          <div>
            <h3 className="text-sm font-semibold text-text-primary mb-4">Nawigacja</h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/create" className="text-sm text-text-secondary hover:text-text-primary transition-colors">
                  Dodaj Antystykę
                </Link>
              </li>
              <li>
                <Link to="/topka" className="text-sm text-text-secondary hover:text-text-primary transition-colors">
                  Topka
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-sm font-semibold text-text-primary mb-4">Informacje</h3>
            <ul className="space-y-2">
              <li>
