...
namespace Antystics.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260318211708_SourcePerformanceGovernance")]
    partial class SourcePerformanceGovernance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Antystics.Core.Entities.Antistic", b =>
                {
                    ...
                    b.Property<Guid?>("OriginalAntisticId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("SourceStatisticId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OriginalAntisticId");

                    b.HasIndex("PublishedAt");

                    b.HasIndex("SourceStatisticId");
            ...
            modelBuilder.Entity("Antystics.Core.Entities.ContentGenerationRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("CreatedAntysticsCount")
                        .HasColumnType("integer");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("CreatedStatisticsCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("RequestedAntystics")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("RequestedStatistics")
                        .HasColumnType("integer");

                    b.Property<string>("SkippedSourcesJson")
                        .HasColumnType("text");

                    b.Property<int>("SourceFailureCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("SourcePerformanceJson")
                        .HasColumnType("text");
                    ...
                    b.Property<int>("ValidationFailureCount")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("content_generation_runs", (string)null);
                });
            ...
            modelBuilder.Entity("Antystics.Core.Entities.Statistic", b =>
                {
                    ...
                    b.Property<string>("ProvenanceData")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Antystics.Core.Entities.VisitorMetric", b =>
                {
            ...
            modelBuilder.Entity("Antystics.Core.Entities.Antistic", b =>
                {
                    ...
                    b.HasOne("Antystics.Core.Entities.Antistic", "OriginalAntistic")
                        .WithMany()
                        .HasForeignKey("OriginalAntisticId");

                    b.HasOne("Antystics.Core.Entities.Statistic", "SourceStatistic")
                        .WithMany()
                        .HasForeignKey("SourceStatisticId")
                    ...
                    b.Navigation("OriginalAntistic");

                    b.Navigation("SourceStatistic");
